  ...
  return (
    <ConvexProvider client={convex}>
      ...
      <div className="min-h-screen bg-wic-bg text-wic-text font-sans selection:bg-wic-sage selection:text-white pb-0">
        {/* Main Home Screen */}
        <main className="max-w-md mx-auto min-h-[100dvh] flex flex-col relative bg-white shadow-2xl overflow-hidden sm:ring-1 sm:ring-black/5">
          ...
          <div className="flex-1 flex flex-col items-center px-6 gap-8 pb-10 -mt-6 z-20 overflow-y-auto">
              ...
              <div className="w-full flex items-center justify-center shrink-0">
                  <button
                      ...
                      className="group relative w-[180px] h-[180px] sm:w-[200px] sm:h-[200px] bg-white rounded-[3rem] shadow-[0_10px_40px_rgba(0,0,0,0.08)] hover:shadow-[0_15px_50px_rgba(224,122,95,0.15)] transition-all duration-300 active:scale-95 border border-stone-100 flex flex-col items-center justify-center gap-4 overflow-hidden"
                  >
              ...
              <div className="w-full flex flex-col gap-6 w-full">
                  ...
                  <div className="bg-wic-bg p-5 sm:p-6 rounded-[2rem] border border-stone-200/50 shadow-sm transition-shadow hover:shadow-md">
                  ...
                  <div className="flex flex-col gap-0 overflow-hidden bg-white border border-stone-200/70 rounded-[2rem] shadow-sm">
                    <div className="p-5 sm:p-6 border-b border-stone-100 flex flex-col gap-3">
